...
module Marketo
  module Concerns
    module API
      ...
      #
      # Returns a Marketo::Collection if Marketo.configuration.mashify is true.
      # Returns an Array of Hash for each record in the result if
      # Marketo.configuration.mashify is false.
      ...
      #
      # Returns the Marketo::SObject sobject record.
      ...
      #         records per object.
      #
      # Returns an array of the recently viewed Marketo::SObject records.
